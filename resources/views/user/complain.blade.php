                        ...
                        <div class="col-lg-11 col-12">
                            <div class="row border-bottom border-2 border-primary">
                                <div class="col-lg-8 col-md-7 col-sm-6 col-6 d-none d-sm-block">
                                    <div class="text-start py-3 fs-4 fw-bold card-title">{{ __('History Table') }}
                                    </div>
                                </div>
                                                ...
                                                <table class="table table-bordered">
                                                    <thead class="table-primary">
                                                        <tr class="text-center">
                                                            <th scope="col">{{ __('Incident Event') }}</th>
                                                    ...
                                                    <tbody>
                                                        @foreach ($complain as $complains)
                                                            <tr>
                                                                <td class="text-center" scope="row">{{ $complains->incident_event }}</td>
                                                                ...
                                                                <td class="text-center" scope="row">
                                                                    <button type="button" class=" btn btn-success bi bi-eye-fill" data-bs-toggle="modal" data-bs-target="#viewForm{{ $complains->id }}"></button>
                                                                    <a href="#" class="btn btn-danger" onclick="return confirm('Are you sure to remove this complain?')">
                                                                        <i class="bi bi-trash"></i>
                                                                    </a>
                                                                    {{-- View Profile Modal --}}
                                                                    <div class="modal fade modal-alert" id="viewForm{{ $complains->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
